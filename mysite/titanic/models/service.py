...
class Service(object):
    ...
    def create_train(this) -> object:
        return this.train.drop('Survived', axis=1) # axis 0 행(가로) 1 열(세로)
    ...
    @staticmethod
    def embarked_norminal(this) -> object: # this 가 변형될거니까 static ?
    ...
    def fare_ordinal(this) -> object:
        ...
        this.train['FareBand'] = pd.qcut(this.train['Fare'], 4, labels={1,2,3,4}) # 최고의 최저를 통해 4등분하라
        this.test['FareBand'] = pd.qcut(this.test['Fare'], 4, labels={1,2,3,4}) # 최고의 최저를 통해 4등분하라
        return this
